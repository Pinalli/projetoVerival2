...
<div class="jumbotron mb-5">
    <h1 style="color: #787a89;"><span class="icon-editar text-info"></span> Editar Ficha Técnica de Preparo</h1>
    <hr />
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" value="<%=ficha.getNome()%>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="nome">Rendimento</label>
                        <input type="text" class="form-control" id="rendimento" name="rendimento" value="<%=ficha.getRendimento()%>"/>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="nome">Tempo de Preparo</label>
                        <input type="text" class="form-control" id="tempoDePreparo" name="tempoDePreparo" value="<%=ficha.getTempoPreparo()%>"/>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-6">
            ...
            <div class="col-sm-6 text-center">
                ...
                <div class="form-group col-12">
                    ...
                    <input id="imgFile" name="imgFile" type='file' value="<%= ficha.getFoto() %>">
                </div>
                <div class="form-group col-md-12">
                    <div id="image_preview">
                        <img id="previewing" src="upload/fichas/ficha-<%= ficha.getIdFicha() %>/<%= ficha.getFoto()%>" class="img-responsive img-thumbnail center-block" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="utensiliosEquipamentos"
                              name="utensiliosEquipamentos" rows="4"><%=ficha.getUtensilios()%></textarea>
                </div>

                <div class="form-group">
                    <label for="modoPreparo">Modo de Preparo</label>
                    <textarea class="form-control" id="modoPreparo"
                              name="modoPreparo" rows="4"><%=ficha.getModoPreparo()%></textarea>
                </div>

                <div class="form-group">
                    <label for="montagem">Montagem</label>
                    <textarea class="form-control" id="montagem"
                              name="montagem" rows="4"><%=ficha.getMontagem()%></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="orientacaoArmazenamento"
                              name="orientacaoArmazenamento" rows="4"><%=ficha.getOrientacoesArmazenamento()%></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="textura"
                              name="textura" rows="4"><%=ficha.getTextura()%></textarea>
                </div>

                <div class="form-group">
                    <label for="sabor">Sabor</label>
                    <textarea class="form-control" id="sabor"
                              name="sabor" rows="4"><%=ficha.getSabor()%></textarea>
                </div>

                <div class="form-group">
                    <label for="apresentacao">Apresentação</label>
                    <textarea class="form-control" id="apresentacao"
                              name="apresentacao" rows="4"><%=ficha.getApresentacao()%></textarea>
                </div>

                <div class="form-group">
                    <label for="temperatura">Temperatura</label>
                    <textarea class="form-control" id="temperatura"
                              name="temperatura" rows="4"><%=ficha.getTemperatura()%></textarea>
                </div>
            </div>
        </div>
