...
VALUES
('10', '17338792000101', '5199677239', 'Go Horse Soluções', 'r. das empresas, 69', 'Ponta Grossa', 'Socialista Racional', 'Hortencia', null, '2015-10-01 00:00:00');


/*----------SCRIPT FICHA SIMPLIFICADA----------*/

-- Tabela Ficha simplificada
CREATE TABLE `TB_FICHA_SIMPLIFICADA` (
  `ID_FICHA_SIMPLIFICADA` INT NOT NULL,
  ...
  `DATA_INCLUSAO` DATETIME DEFAULT NULL,
  PRIMARY KEY (`ID_FICHA_SIMPLIFICADA`));

-- TABELA ITEM DA FICHA SIMPLIFICADA 
CREATE TABLE `TB_FICHA_SIMPLIFICADA_ITEM` (
  `ID_FICHA_SIMPLIFICADA_ITEM` INT NOT NULL,
  ...
  `ID_FICHA_SIMPLIFICADA` INT NOT NULL,
  `DATA_INCLUSAO` DATETIME DEFAULT NULL,
  PRIMARY KEY (`ID_FICHA_SIMPLIFICADA_ITEM`),
    ...
    FOREIGN KEY (`ID_INGREDIENTES`) REFERENCES `FICHA_E`.`TB_INGREDIENTES` (`ID`),
    FOREIGN KEY (`ID_FICHA_SIMPLIFICADA`) REFERENCES `FICHA_E`.`TB_FICHA_SIMPLIFICADA` (`ID_FICHA_SIMPLIFICADA`)
	);